...
function exportPdf() {
  ...
  content.push(
    ...
    //   columns: [
    //     {
    //       text: 'ขอยื่นคำขอต่อพนักงานเจ้าหน้าที่',
    //       marginLeft: 55,
    //       // marginRight: 10
    //     },
    //     { image: checkBox(0, 1), width: 15, hight: 15, marginTop: 5, marginLeft: -15 },
    //     { text: 'กรุงเทพมหานคร', marginLeft: -20, marginTop: 3, style: 'body' }
    //   ]
    // },
    // {
    //   columns: [
    //     { image: checkBox(0, 2), width: 15, hight: 15, marginTop: 5, marginLeft: -15 },
    //     { text: 'อำเภอ/กิ่งอำเภอ' + '.'.repeat(25) + 'จังหวัด' + '.'.repeat(27), marginLeft: -20, marginTop: 3, style: 'body' }
    //   ],
    //   margin: [235, 0, 0, 10]
    // },
    {
    ...
    {
      text: 'เป็นจำนวนเงินหรือทรัพย์สินอื่นอย่างสูงที่ขออนุญาตเรี่ยไร',
      style: 'body',
    },
    {
      text: 'ภายในเขตและสถานที่',
      style: 'body',
      // marginLeft: 30,
    },
    {
      text: 'วิธีการเก็บรักษาและทำบัญชีเงินหรือทรัพย์สินที่เรี่ยไรได้',
      style: 'body',
    },
    {
      text: 'วิธีทำการเรี่ยไร',
      style: 'body',
    },
    {
  ...
  const docDefination = {
    ...
    content: [
      ...
      {
        text: 'ใบอนุญาตจัดให้มีการเรี่ยไร',
        alignment: 'center',
        style: 'header',
        bold: true,
      },
